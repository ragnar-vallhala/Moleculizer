...
std::unordered_map<std::string, glm::vec3> Utils::atomColor = {
...
std::unordered_map<std::string, float> Utils::atomRadius = {
    {"H", 0.31f},    // Hydrogen
    {"C", 0.76f},    // Carbon
    {"N", 0.71f},    // Nitrogen
    {"O", 0.66f},    // Oxygen
...
std::unordered_map<std::string, float> Utils::covalentRadii = {
    {"H", 0.31f},       // Hydrogen
    {"C", 0.76f},       // Carbon
    {"N", 0.71f},       // Nitrogen
    {"O", 0.66f},       // Oxygen
